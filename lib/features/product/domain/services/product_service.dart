...
class ProductService implements ProductServiceInterface {
  ...
  Future<ApiResponseModel<T>> getMostSearchingProductList<T>(
    ...
    return await productRepositoryInterface.getMostSearchingProductList(
  ...
  Future<ApiResponseModel<T>> getClearanceAllProductList<T>(
      {required int offset, required DataSourceEnum source}) async {
    return await productRepositoryInterface.getClearanceAllProductList(
        offset: offset, source: source);
  }
  ...
  Future<ApiResponseModel<T>> getProductModelByType<T>(
      ...
      required DataSourceEnum source}) async {
    return await productRepositoryInterface.getProductModelByType(
        offset: offset, productType: productType, source: source);
  }
}
