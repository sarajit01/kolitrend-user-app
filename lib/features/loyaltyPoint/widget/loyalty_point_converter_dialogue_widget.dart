                        ...
                        child: Column(children: [
                          ...
                          CustomTextFieldWidget(
                              ...
                              onChanged: (value) {
                                if (value.isNotEmpty) {
                                  setState(() {
                                    convertPointAmount = double.parse(value) /
                                        ((exchangeRate ?? 0) /
                          ...
                          const SizedBox(height: Dimensions.paddingSizeSmall),
                          Text(
                              '${getTranslated('converted_amount', context)} = ${PriceConverter.getUnitCurrency(context, convertPointAmount)}',
                              style: textRegular.copyWith(
                                  color: Theme.of(context).primaryColor,
                        ...
                        children: [
                          ...
                          PointWithTextWidget(
                              ...
                              textColor:
                                  Theme.of(context).textTheme.bodyLarge?.color,
                              text:
                                  '${exchangeRate ?? 0}  ${getTranslated('note_point_two', context)} '
