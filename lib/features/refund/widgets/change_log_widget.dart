  ...
  Widget build(BuildContext context) {
    return Consumer<RefundController>(builder: (context, refundReq, _) {
      return Container(
        ...
        child: refundReq.refundResultModel != null
            ? (refundReq.refundResultModel!.refundRequest != null &&
                    refundReq.refundResultModel!.refundRequest!.isNotEmpty)
                ? ListView.builder(
                    shrinkWrap: true,
                    physics: const BouncingScrollPhysics(),
                    itemCount: refundReq.refundResultModel!.refundRequest![0]
                        .refundStatus?.length,
                          ...
                          Expanded(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    ItemWidget(
                                        lestValue: 'refund_request_status',
  ...
  Widget build(BuildContext context) {
    return Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(rightValue?.capitalize() ?? '',
