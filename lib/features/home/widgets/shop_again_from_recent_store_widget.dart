                ...
                child: Column(
                  ...
                  Row(mainAxisSize: MainAxisSize.min, children: [
                    Container(
                      ...
                      child: CustomImageWidget(
                        image:
                            '${(shopAgainFromRecentStoreModel?.isAddedByAdmin ?? false) ? configModel?.companyLogo?.path : shopAgainFromRecentStoreModel?.seller?.shop?.imageFullUrl?.path}',
                      ),
                    ),
                    const SizedBox(width: Dimensions.paddingSizeSmall),
                    Expanded(
                        child: Text(
                      '${(shopAgainFromRecentStoreModel?.isAddedByAdmin ?? false) ? configModel?.companyName : shopAgainFromRecentStoreModel?.seller?.shop?.name}',
