...
class Orders {
  ...
  OrderReceivedPackagePicture? receivedPackagePicture;
  ...
  Orders({
   ...
   // custom code
    ...
    this.receivedPackageWeight,
    this.storeName,
    this.createdAtFormatted,

    this.receivedPackagePicture,
  ...
  Orders.fromJson(Map<String, dynamic> json) {
    ...
    receivedPackagePicture = json['received_package_picture'] != null ? OrderReceivedPackagePicture.fromJson(json['received_package_picture']) : null;
...
class OrderReceivedPackagePicture {
  int? orderId;
  String? imgUrl;
  String? destinationType;

  OrderReceivedPackagePicture({
     this.orderId, this.imgUrl, this.destinationType
  });

  OrderReceivedPackagePicture.fromJson(Map<String, dynamic> json) {
