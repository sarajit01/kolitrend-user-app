...
class SelectShippingPackageTypeBottomSheetWidget extends StatefulWidget {
  ...
  SelectShippingPackageTypeBottomSheetWidget({
    super.key,
    this.selectedShippingPackageType,
  ...
  @override
  State<SelectShippingPackageTypeBottomSheetWidget> createState() =>
      _SelectShippingPackageTypeBottomSheetWidgetState();
}

class _SelectShippingPackageTypeBottomSheetWidgetState
    extends State<SelectShippingPackageTypeBottomSheetWidget> {
  late ShippingPackageType? selectedShippingPackageType;
  ...
  @override
  void initState() {
    selectedShippingPackageType = widget.selectedShippingPackageType;
    ...
    if (countryOfOrigin == null) {
      ...
      Provider.of<KolitrendShippingController>(context, listen: false)
          .getShippingPackageTypes(countryOfOrigin!, destinationCountry!, shippingModeId!, shippingCompanyId!);
    }
  }
      ...
      return SingleChildScrollView(
        child: Container(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Text(getTranslated('Select Package Type', context)!,
            ...
            Padding(
                ...
                child: Text(
                    '${getTranslated('Select package types from the list', context)}',
            ...
            SizedBox(
              ...
              child: SingleChildScrollView(
                child: ListView.builder(
                    ...
                    itemCount:
                        kolitrendShippingController.shippingPackageTypesList?.length,
                    shrinkWrap: true,
                            ...
                            setState(() {
                              selectedShippingPackageType =
                                  kolitrendShippingController
                                      .shippingPackageTypesList![index];
                            });
                          },
                          child: Padding(
                              ...
                              child: Container(
                                  decoration: BoxDecoration(
                                      ...
                                      color: selectedShippingPackageType?.id ==
                                              kolitrendShippingController
                                                  .shippingPackageTypesList![
                                                      index]
                                                  .id
                                          ? Theme.of(context)
                                              .primaryColor
            ...
            Padding(
                ...
                child: CustomButton(
                  ...
                  onTap: () =>
                      {Navigator.pop(context, selectedShippingPackageType)},
                )),
