...
class SelectShippingServiceBottomSheetWidget extends StatefulWidget {
  ...
  SelectShippingServiceBottomSheetWidget({
    super.key,
  ...
  @override
  State<SelectShippingServiceBottomSheetWidget> createState() =>
      _SelectShippingServiceBottomSheetWidgetState();
}

class _SelectShippingServiceBottomSheetWidgetState
    extends State<SelectShippingServiceBottomSheetWidget> {
  late ShippingService? selectedShippingService;

  late String? countryOfOrigin;
  late String? destinationCountry;
  late int? shippingModeId;
  late int? shippingCompanyId;
  late int? shippingPackageId;

  @override
  void initState() {
    selectedShippingService = widget.selectedShippingService;
    ...
    shippingPackageId = widget.shippingPackageTypeId;
    ...
    if (countryOfOrigin == null) {
      ...
      showCustomSnackBar(
          ...
          Get.context!,
          isError: true);
    } else if (shippingPackageId == null) {
      showCustomSnackBar(
      ...
      Provider.of<KolitrendShippingController>(context, listen: false)
          .getShippingServices(countryOfOrigin!, destinationCountry!, shippingModeId!, shippingCompanyId!, shippingPackageId!);
    }
  }
      ...
      return SingleChildScrollView(
        child: Container(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Text(getTranslated('Select Shipping Service', context)!,
            ...
            Padding(
                ...
                child: Text(
                    '${getTranslated('Select shipping service from the list', context)}',
            ...
            SizedBox(
              ...
              child: SingleChildScrollView(
                child: ListView.builder(
                    ...
                    itemCount:
                        kolitrendShippingController.shippingServicesList?.length,
                    shrinkWrap: true,
                    itemBuilder: (context, index) {
                      return InkWell(
                          onTap: () {
                            setState(() {
                              selectedShippingService = kolitrendShippingController.shippingServicesList![index];
                            });
                          },
                          child: Padding(
                              ...
                              child: Container(
                                  decoration: BoxDecoration(
                                      ...
                                      color: selectedShippingService?.id ==
            ...
            Padding(
                ...
                child: CustomButton(
                  ...
                  onTap: () =>
                      {Navigator.pop(context, selectedShippingService)},
                )),
