...
import '../../buy_for_me/screens/buy_for_me_form_screen.dart';
import '../../combine_ship/screens/combine_ship_form_screen.dart';
import '../../kolitrend_shipping/screens/kolitrend_shipping_form_screen.dart';
import '../../my_requests/screens/my_requests.dart';
                  ...
                  child: Container(
                    ...
                    child: Column(children: [
                      MenuButtonWidget(
                        ...
                        navigateTo: const MyRequestsScreen(),
                      ),
                      MenuButtonWidget(
                        image: Images.trackOrderIcon,
                        title: getTranslated('Buy for me', context),
                        navigateTo: const BuyForMeFormScreen(),
                      ),
                      MenuButtonWidget(
                        image: Images.trackOrderIcon,
                        title: getTranslated('Kolitrend Shipping', context),
                        navigateTo: const KolitrendShippingFormScreen(),
                      ),
                      MenuButtonWidget(
                        image: Images.trackOrderIcon,
                        title: getTranslated('Combine & Ship', context),
                        navigateTo: const CombineShipFormScreen(),
                      ),
                      MenuButtonWidget(
                        image: Images.trackOrderIcon,
                              ...
                              MenuButtonWidget(
                                  ...
                                  navigateTo: HtmlViewScreen(
                                      page: getPageBySlug(
                                          ...
                                          splashController
                                              .defaultBusinessPages))),
                            if (getPageBySlug('shipping-policy',
                                    splashController.defaultBusinessPages) !=
                                null)
                              MenuButtonWidget(
                                  image: Images.termCondition,
