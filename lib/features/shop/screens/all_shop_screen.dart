...
class _AllTopSellerScreenState extends State<AllTopSellerScreen> {
  ...
  void initState() {
    ...
    Provider.of<ShopController>(context, listen: false)
        .setSellerType('top', notify: false);
  }
              ...
              child: PopupMenuButton(
                itemBuilder: (context) => [
                  PopupMenuItem(
                      ...
                      child: Text(getTranslated('new_seller', context) ?? '')),
                  PopupMenuItem(
                      value: "all",
                      textStyle: textRegular.copyWith(
                          color: Theme.of(context).hintColor),
                      child: Text(getTranslated('all_seller', context) ?? '')),
                  PopupMenuItem(
                      value: "top",
                      textStyle: textRegular.copyWith(
                          color: Theme.of(context).hintColor),
                      child: Text(getTranslated('top_seller', context) ?? '')),
                ],
          ...
          body: Padding(
            ...
            child: Consumer<ShopController>(
              ...
              return (topSellerProvider
                          .filteredSellerModel?.sellers?.isNotEmpty ??
                      false)
                  ? PaginatedListView(
                  ...
                  : (topSellerProvider.filteredSellerModel?.sellers?.isEmpty ??
                          false)
                      ? const SizedBox()
                      : const SellerShimmer();
            }),
