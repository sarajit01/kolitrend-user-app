                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            CustomTextFieldWidget(
                              ...
                              hintText: getTranslated('John', context),
                              ...
                              validator: (value) =>
                                  ValidateCheck.validateEmptyText(
                                      value, "first_name_is_required"),
                            ),
                            const SizedBox(
                                height: Dimensions.paddingSizeDefaultAddress),
                            CustomTextFieldWidget(
                              labelText: getTranslated('Last Name', context),
                              hintText: getTranslated('Doe', context),
                              inputType: TextInputType.text,
                              inputAction: TextInputAction.next,
                              focusNode: _lastNameNode,
                              prefixIcon: Images.username,
                              required: true,
                              nextFocus: _companyNode,
                              controller: _lastNameController,
                              validator: (value) =>
                                  ValidateCheck.validateEmptyText(
                                      value, "last_name_is_required"),
                            ),
                            const SizedBox(
                                height: Dimensions.paddingSizeDefaultAddress),
                            CustomTextFieldWidget(
                              labelText: getTranslated('Company Name', context),
                              hintText: getTranslated('ABC LLC', context),
                              inputType: TextInputType.text,
                              inputAction: TextInputAction.next,
                              focusNode: _companyNode,
                              prefixIcon: Images.aboutUs,
                              required: true,
                              nextFocus: _emailNode,
                              controller: _companyController,
                              validator: (value) =>
                                  ValidateCheck.validateEmptyText(
                                      value, getTranslated("Company name is required", context)),
                            ),
                            const SizedBox(
                                height: Dimensions.paddingSizeDefaultAddress),
                            CustomTextFieldWidget(
                              labelText:
                                  getTranslated('Email Address', context),
                              ...
                              validator: (value) =>
                                  ValidateCheck.validateEmptyText(
                                      value, getTranslated("Email address is required", context)),
                            ),
                            const SizedBox(
                                height: Dimensions.paddingSizeDefaultAddress),
                            CustomTextFieldWidget(
