            ...
            builder: (ctx, details, child) {
              return Column(
                  ...
                  children: [
                    ...
                    CustomImageWidget(
                        image: widget.notificationBody?.image ?? '',
                        height: 100,
                        width: 100),
                    const SizedBox(height: Dimensions.paddingSizeSmall),
                    Text(widget.notificationBody?.title ?? '',
                        maxLines: 2,
                    ...
                    Text(
                        widget.notificationBody?.status == 'product_restocked'
                            ? getTranslated(
                                'this_product_has_been_restock', context)!
                            : getTranslated(
                                'this_product_has_been_updated', context)!,
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                        textAlign: TextAlign.center,
