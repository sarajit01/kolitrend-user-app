    ...
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        const Padding(
            ...
            child:
                CustomAssetImageWidget(Images.delete, height: 60, width: 60)),
        const SizedBox(height: Dimensions.paddingSizeExtraSmall),
        Text(
          getTranslated('are_you_sure', context)!,
        ...
        Padding(
            ...
            child: Text(
              '${getTranslated('want_to_remove_all_restock', context)}',
                  ...
                  child: SizedBox(
                      ...
                      child: CustomButton(
                          ...
                          onTap: () {
                            ...
                            Provider.of<RestockController>(context,
                                    listen: false)
                                .deleteRestockProduct(null, 'all', null);
