...
class CartRepository extends DataSyncService
  ...
  Future<ApiResponseModel<T>> getCartData<T>(
    ...
    final guestToken = Provider.of<AuthController>(Get.context!, listen: false)
        .getGuestToken();
    return await fetchData<T>(
        '${AppConstants.getCartDataUri}?guest_id=$guestToken', source);
  }
  ...
  @override
  Future<ApiResponseModel> addToCartListData(
      CartModelBody cart,
  ...
  @override
  Future<ApiResponseModel> addRemoveCartSelectedItem(
