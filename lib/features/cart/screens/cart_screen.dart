...
class CartScreenState extends State<CartScreen> {
  ...
  void initState() {
    print(
        '-----IsCartLoading----->>${Provider.of<CartController>(Get.context!, listen: false)?.cartLoading}<<--------');
    ...
    return Consumer<SplashController>(builder: (context, configProvider, _) {
      return Consumer<ShippingController>(
        ...
        return Consumer<CartController>(builder: (context, cart, child) {
          ...
          print(
              '-----IsCartLoading---22-->>${Provider.of<CartController>(Get.context!, listen: false)?.cartLoading}<<--------');
                                ...
                                child: RepaintBoundary(
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      print(
                                          '---shippingMethod--->>${configProvider.configModel!.shippingMethod}');
                                      print(
                                          '---orderWise--->>${sellerGroupList[index].shippingType == 'order_wise'}');
                                      print(
                                          '---orderWise--2-->>${sellerGroupList[index].shippingType}');
                                      print(
                                                                        ...
                                                                        children: [
                                                                          SizedBox(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              side: WidgetStateBorderSide.resolveWith((states) => BorderSide(width: 2, color: Theme.of(context).colorScheme.tertiaryContainer)),
                                                                          ...
                                                                          Flexible(
                                                                            child:
                                                                              ...
                                                                              child: Text(sellerGroupList[index].shopInfo!, maxLines: 1, overflow: TextOverflow.ellipsis, textAlign: TextAlign.start, style: textBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Provider.of<ThemeController>(context, listen: false).darkTheme ? Theme.of(context).hintColor : Theme.of(context).primaryColor)),
                                                                            ),
                                                                          ),
                                                                          Padding(
