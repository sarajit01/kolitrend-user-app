            ...
            return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (ctx, i) {
                                return Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeExtraSmall),
                                  child: InkWell(onTap: () => productDetailsController.setCartVariationIndex(widget.product!.minimumOrderQty, index, i, context),
              ...
              Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.homePagePadding),
                  child: Row(children: [
                    ...
                    QuantityButton(isIncrement: false, quantity: productDetailsController.quantity,
                    ...
                    QuantityButton(isIncrement: true, quantity: productDetailsController.quantity, stock: stock,
