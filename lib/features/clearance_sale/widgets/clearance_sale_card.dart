...
class ClearanceSaleWidget extends StatelessWidget {
  ...
  const ClearanceSaleWidget(
      {super.key, required this.product, this.isCenterElement});
        ...
        return AnimatedContainer(
          margin: isCenterElement == null
              ...
              : EdgeInsets.symmetric(
                  vertical: isCenterElement! ? 0 : Dimensions.paddingSizeEight),
                    ...
                    FittedBox(
                        child: Row(
                          ...
                          ((product.discount != null &&
                                      product.discount! > 0) ||
                                  (product.clearanceSale?.discountAmount ?? 0) >
                                      0)
                              ? Text(
