...
class ClearanceSearchBarWidget extends StatefulWidget {
  ...
  const ClearanceSearchBarWidget(
      {super.key,
      ...
      required this.handleSearchText,
      required this.onSearchClick,
      required this.searchIcon});

  @override
  State<ClearanceSearchBarWidget> createState() =>
      _ClearanceSearchBarWidgetState();
}
...
class _ClearanceSearchBarWidgetState extends State<ClearanceSearchBarWidget> {
  ...
  void initState() {
    ...
    if (widget.fromShop) {
      authorList = Provider.of<SearchProductController>(context, listen: false)
          .sellerAuthorsList;
      publishingHouse =
