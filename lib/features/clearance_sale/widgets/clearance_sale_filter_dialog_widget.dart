...
class ClearanceProductFilterDialog extends StatefulWidget {
  ...
  const ClearanceProductFilterDialog(
      {super.key,
      this.sellerId,
      this.fromShop = true,
      this.authorList,
  ...
  @override
  ClearanceProductFilterDialogState createState() =>
      ClearanceProductFilterDialogState();
}

class ClearanceProductFilterDialogState
    extends State<ClearanceProductFilterDialog> {
  List<int> authors = [];
                            ...
                            children: [
                              ...
                              if ((_authorList!.isNotEmpty) &&
                                  (searchProvider.productTypeIndex == 0 ||
                                      searchProvider.productTypeIndex ==
                                          2)) ...[
                                const SizedBox(
                                    height: Dimensions.paddingSizeSmall),
                                Text(
                                          ...
                                          itemBuilder: (context, index) {
                                            return Column(
                                              children: [
                                                CategoryFilterItem(
                                                  title:
                                                      _authorList![index].name,
                                                  checked: _authorList![index]
                                                      .isChecked!,
                                                  onTap: () {
                                                    searchProvider
