...
class ClearanceShopListWidget extends StatelessWidget {
  ...
  const ClearanceShopListWidget(
      {super.key, this.sellerId, this.isHomeScreen = true});

  @override
  Widget build(BuildContext context) {
    return Consumer<ShopController>(builder: (context, shopController, child) {
      return shopController.clearanceProductModel != null
          ? (shopController.clearanceProductModel?.products != null &&
                          ...
                          children: [
                            Padding(
                              ...
                              child: ClearanceTitleRowWidget(
                                ...
                                onTap: () => Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (_) =>
                                            ClearanceSaleShopProductScreen(
                                                sellerId: sellerId!))),
                              ),
                            ),
                            CarouselSlider.builder(
                                ...
                                itemBuilder: (context, index, _) =>
                                    ClearanceSaleWidget(
                                      product: shopController
                                          .clearanceProductModel!
                                          .products![index],
                                      isCenterElement: index ==
                                          shopController
                                              .clearanceSaleProductSelectedIndex,
                                    )),
                          ],
                        );
                      }),
