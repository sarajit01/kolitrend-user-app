    ...
    return SizedBox(
      ...
      child: Stack(children: [
        ...
        Positioned(
            child: Align(
                alignment:
                    isHomeScreen ? Alignment.bottomCenter : Alignment.center,
                child: Padding(
...
class _TitleBackgroundImagePaint extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.cubicTo(
        size.width * 0.97, 0, size.width * 0.02, 0, size.width * 0.02, 0);
    path.cubicTo(
        size.width * 0.01, 0, 0, size.height * 0.06, 0, size.height * 0.13);
    path.cubicTo(
        0, size.height * 0.13, 0, size.height * 0.88, 0, size.height * 0.88);
    path.cubicTo(0, size.height * 0.94, size.width * 0.01, size.height,
        size.width * 0.02, size.height);
    path.cubicTo(size.width * 0.02, size.height, size.width, size.height,
        size.width, size.height);
    path.cubicTo(size.width, size.height, size.width, size.height * 0.96,
        size.width, size.height * 0.94);
    path.cubicTo(size.width, size.height * 0.94, size.width * 0.92,
        size.height * 0.53, size.width * 0.92, size.height * 0.53);
    path.cubicTo(size.width * 0.92, size.height * 0.52, size.width * 0.92,
        size.height / 2, size.width * 0.92, size.height * 0.48);
    path.cubicTo(size.width * 0.92, size.height * 0.48, size.width * 0.98,
        size.height * 0.06, size.width * 0.98, size.height * 0.06);
    path.cubicTo(size.width * 0.98, size.height * 0.03, size.width * 0.98, 0,
        size.width * 0.97, 0);
    path.cubicTo(
  ...
  Widget build(BuildContext context) {
    return !isLtr
        ? Transform.flip(
            flipX: true,
            child: Image.asset(
              Images.clearanceShopTitle,
              width: MediaQuery.sizeOf(context).width / 2.2,
            ))
        : SizedBox(
            width: size / 2.2,
            child: CustomPaint(
              painter: _TitleBackgroundImagePaint(),
              child: const Padding(
                padding: EdgeInsets.symmetric(
