...
class CustomAppBarWithAction extends StatelessWidget
  ...
  final Widget? reset;
  final bool showLogo;
  final Widget? actionIconWidget; // New: The icon to display
  final VoidCallback? onActionPressed; // New: The function to call on tap
  ...
  Widget build(BuildContext context) {
    // Logic to build the list of actions for the AppBar
    List<Widget> getActions() {
      List<Widget> actionList = [];
      if (showResetIcon && reset != null) {
        actionList.add(reset!);
      }
      if (actionIconWidget != null && onActionPressed != null) {
        actionList.add(
          Padding(
        ...
        //           color: actionIconColor ??  Theme.of(context).hintColor, size: 24),
        //       onPressed: onActionPressed,
        //       tooltip: 'Action', // Optional: for accessibility
        //     ),
        //   );
      }
      return actionList;
