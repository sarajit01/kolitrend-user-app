...
class AppConstants {
  static const String appName = 'Kolitrend';
  ...
  static const String baseUrl = 'https://www.kolitrend.com';
  ...
  static const String addressListUriV2 = '/api/v1/customer/address/list-v2';
  ...
  static const String myRequestsUri =
      '/api/v1/customer/requests/list?limit=10&offset=';
  ...
  static const String shippingPackageTypes = '/shipping-packages';
  static const String shippingServices = '/shipping-services';
  ...
  static const String countryList =
      '/api/v1/customer/get-country-list';
