...
import 'package:flutter_sixvalley_ecommerce/features/buy_for_me/domain/repositories/buy_for_me_repository.dart';
import 'package:flutter_sixvalley_ecommerce/features/buy_for_me/domain/repositories/buy_for_me_repository_interface.dart';
import 'package:flutter_sixvalley_ecommerce/features/buy_for_me/domain/services/buy_for_me_service.dart';
...
import 'package:flutter_sixvalley_ecommerce/features/kolitrend_shipping/domain/repositories/kolitrend_shipping_repository.dart';
...
import 'package:flutter_sixvalley_ecommerce/features/my_requests/domain/repositories/my_requests_repository.dart';
import 'package:flutter_sixvalley_ecommerce/features/my_requests/domain/services/my_request_service.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton(() => MyRequestRepository(dioClient: sl()));
  sl.registerLazySingleton(
  ...
  // custom code
  sl.registerFactory(
      () => MyRequestsController(myRequestServiceInterface: sl()));
  sl.registerFactory(
          () => KolitrendShippingController(kolitrendShippingServiceInterface: sl()));
  sl.registerFactory(
          () => BuyForMeController(buyForMeServiceInterface: sl()));
  // end custom code
  ...
  MyRequestRepositoryInterface myRequestRepositoryInterface =
      MyRequestRepository(dioClient: sl());
  sl.registerLazySingleton(() => myRequestRepositoryInterface);
  MyRequestServiceInterface myRequestServiceInterface =
      MyRequestService(myRequestRepositoryInterface: sl());
  sl.registerLazySingleton(() => myRequestServiceInterface);

  KolitrendShippingRepositoryInterface kolitrendShippingRepositoryInterface =
  KolitrendShippingRepository(dioClient: sl());
  sl.registerLazySingleton(() => kolitrendShippingRepositoryInterface);
  KolitrendShippingServiceInterface kolitrendShippingServiceInterface =
  KolitrendShippingService(kolitrendShippingRepositoryInterface: sl());
  sl.registerLazySingleton(() => kolitrendShippingServiceInterface);


  BuyForMeRepositoryInterface buyForMeRepositoryInterface =
  BuyForMeRepository(dioClient: sl());
  sl.registerLazySingleton(() => buyForMeRepositoryInterface);
  BuyForMeServiceInterface buyForMeServiceInterface =
  BuyForMeService(buyForMeRepositoryInterface: sl());
  sl.registerLazySingleton(() => buyForMeServiceInterface);
